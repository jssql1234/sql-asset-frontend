...
import type { AllocationFilters, AssetStatus, AvailabilityStatus } from "../types";
    ...
    <div className="flex flex-col gap-3 rounded-xl border border-outline bg-surfaceContainer p-4 shadow-sm">
      <div className="flex flex-wrap items-end gap-4">
        ...
        <FilterDropdown
          ...
          onChange={(value) => setFilter("availability", value as string)}
        />
...
interface FilterDropdownProps {
  ...
  value: string;
  placeholder: string;
  options: (string | number | AssetStatus | AvailabilityStatus)[];
