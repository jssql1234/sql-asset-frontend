...
// Mock Work Orders Schedule
export const MOCK_WORK_ORDERS_SCHEDULE: WorkOrders[] = [
  {
    id: "MS-001",
    assetId: "AST-001",
    ...
    notes: "Check hydraulic fluid levels and hoses",
  },
  {
    id: "MS-002",
    assetId: "AST-002",
    assetName: "Bulldozer Komatsu D65",
    assetCode: "BLD-002",
    taskDescription: "Engine Oil Change & Filter Replacement",
    type: "Preventive",
    priority: "High",
    status: "Overdue",
    ...
    notes: "Overdue by 5 days - priority service required",
  },
  {
    id: "MS-003",
    assetId: "AST-003",
    ...
    assetCode: "CRN-003",
    taskDescription: "Load Testing & Safety Inspection",
    type: "Preventive",
    priority: "Critical",
    status: "In Progress",
    scheduledDate: "2025-09-28",
    serviceBy: "Outsourced",
    assignedTechnician: "ABC Crane Services",
    estimatedCost: 5500.0,
    actualCost: 5200.0,
    frequency: "Quarterly",
    notes: "Annual safety certification required",
  },
  {
    id: "MS-004",
    assetId: "AST-004",
    ...
    assetCode: "GEN-004",
    taskDescription: "Load Bank Testing",
    type: "Predictive",
    priority: "Medium",
    status: "Scheduled",
    scheduledDate: "2025-10-15",
    serviceBy: "Outsourced",
    assignedTechnician: "Power Solutions Ltd",
  ...
  },
  {
    id: "MS-005",
    assetId: "AST-005",
    assetName: "Forklift Toyota 8FG25",
    assetCode: "FRK-005",
    taskDescription: "Brake System Maintenance",
    type: "Corrective",
    priority: "High",
    status: "Pending",
    ...
    notes: "Reported brake squeaking - requires inspection",
  },
];
